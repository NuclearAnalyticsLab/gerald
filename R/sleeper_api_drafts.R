...
get_all_user_drafts <- function(user_id, season) {
  ...
  log_message(glue::glue("Fetching user drafts data from {season} season."))
  log_message(glue::glue("User draft data endpoint: {url}"))
  ...
  log_message("Extracting content from user draft data request.")
  content <- httr::content(response, "text")

  # Return the response content
  log_message("Converting user draft data R objects to JSON.")
...
get_all_league_drafts <- function(league_id) {
  ...
  # Log the URL being fetched
  log_message(glue::glue("Fetching all league draft data from endpoint: {url}"))
  ...
  # Extract/parse content
  log_message("Extracting content from all league draft data request.")
  content <- httr::content(response, "text")

  # Return the response content
  log_message("Converting all league draft data R objects to JSON.")
  return(jsonlite::fromJSON(content))
}
...
get_specific_draft <- function(draft_id) {
  ...
  # Log the URL being fetched
  log_message(glue::glue("Fetching draft data from endpoint: {url}"))
  ...
  # Extract/parse content
  log_message("Extracting content from draft data request.")
  content <- httr::content(response, "text")

  # Return the response content
  log_message("Converting draft data R objects to JSON.")
  return(jsonlite::fromJSON(content))
}
...
get_all_draft_picks <- function(draft_id) {
  ...
  # Log the URL being fetched
  log_message(glue::glue("Fetching all draft picks from endpoint: {url}"))
  ...
  # Extract/parse content
  log_message("Extracting content from all draft picks request.")
  content <- httr::content(response, "text")

  # Return the response content
  log_message("Converting all draft picks R objects to JSON.")
  return(jsonlite::fromJSON(content))
}
...
get_traded_draft_picks <- function(draft_id) {
  ...
  # Log the URL being fetched
  log_message(glue::glue("Fetching traded draft picks from endpoint: {url}"))
  ...
  # Extract/parse content
  log_message("Extracting content from traded draft picks request.")
  content <- httr::content(response, "text")

  # Return the response content
  log_message("Converting traded draft picks R objects to JSON.")
  return(jsonlite::fromJSON(content))
}
